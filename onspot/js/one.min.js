...
function hotb() {
  ns(), ss(), us(), rhots(), rnet(), rusb(), document.getElementById( "obox" ).style.display = "none", h.style = "display:block", navitem.init(), navitem.add( {
    ...
    enter()
  }, $(window).on( "keydown", hotk )
}

function hotsb() {
  ns(), hs(), us(), rhot(), rnet(), rusb(),$(window).off('keydown'); s.style = "display:block", document.getElementById( "sname" ).focus();
...
function usbb() {
  ns(), ss(), hs(), rhot(), rhots(), rnet(),$(window).off('keydown'); u.style = "display:block", window.addEventListener( "keydown", usbk )
}

function netb() {
  hs(), ss(), us(), rhot(), rhots(), rusb(),$(window).off('keydown'); n.style = "display:block", window.addEventListener( "keydown", netk )
}
